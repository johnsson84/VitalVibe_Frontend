      ...
      <div className="side-main">
        <nav style={style}>
          ...
          <Link className="sideLink" to="/profile/training">
            ...
            <p className={panelStatus === 1 ? null : "sideLinkHide"}>Logga träning</p>
          </Link>
          ...
          <Link className="sideLink" to="/profile/challenges">
            ...
            <p className={panelStatus === 1 ? null : "sideLinkHide"}>Utmaningar</p>
          </Link>   
          ...
          <Link className="sideLink" to="/profile/settings">
            ...
            <p className={panelStatus === 1 ? null : "sideLinkHide"}>Inställningar</p>
          </Link>
          <Link className="sideLink" onClick={handleShow}>
            <img src="nav_signout.svg" className={panelStatus === 1 ? "linkImg" : null} />
